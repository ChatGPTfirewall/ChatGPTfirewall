...
from .views import (
    UserApiView, UploadApiView, ChatApiView, ContextApiView, NextCloudApiView, DocumentApiView, NextCloudFilesApiView, LanguageAPI, FilesApiView, DownloadApiView
)
...
urlpatterns = [
    ...
    path('documents/download', DownloadApiView.as_view()),
